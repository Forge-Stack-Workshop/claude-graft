...
Place this skill directory at `.claude/skills/blueprint/` in your project (or
`~/.claude/skills/blueprint/` for a user-level install). It is a pure Markdown
skill — no build step, no dependencies to install.

## Requirements

- Claude Code (for the `/blueprint` slash command)
