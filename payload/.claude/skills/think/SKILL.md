...
| User said "判断一下这个报错" and got Evaluation Mode | "判断一下" + error/bug context = debugging, route to a debugging/investigation workflow. Evaluation Mode is for value/existence judgments only |
...
```
Plan approved. To implement: describe what you want built, or say "implement this plan". After implementation, review the changes before merging.
```
